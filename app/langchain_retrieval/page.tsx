        ...
        <div className='max-w-7xl'>
          ...
          <div className='mx-auto lg:mx-0 space-y-4'>
            ...
            <div className='space-y-4'>
              <p>
                In this example we use langchain to split up a large block of text into smaller chunks, then upload
                those chunks to a vector database (Supabase). Then we retrieve the information using a Langchain
                retrieval agent.
              </p>
            </div>
          </div>
